...
#ifndef COMPMATRIX_BGV_H
#define COMPMATRIX_BGV_H
...
public:
    Bgv();
    Ciphertext encrypt(const Plaintext& p1);
    Ciphertext add(const Ciphertext& c1, const Ciphertext& c2);
    Ciphertext mult(const Ciphertext& c1, const Ciphertext& c2);
    Ciphertext multscalar(const Ciphertext& c, const Plaintext& p);
    Plaintext decrypt(const Ciphertext& c1);
private:
    PublicKey publicKey;
    SecretKey secretKey;
    RelinKeys relinKey;
